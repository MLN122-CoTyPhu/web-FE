            ...
            <div className="space-y-2">
              <div className="rounded-xl px-3 py-2.5"
                ...
                <div className="text-xs mt-1" style={{ color: "rgba(255,107,122,0.8)" }}>
                  −30 Tự chủ &nbsp;·&nbsp; −20 Sức mạnh &nbsp;·&nbsp; 2 lượt không thu phí thuê / không thâu tóm được ô mới (vẫn di chuyển và biểu quyết bình thường)
                </div>
              </div>
              <div className="rounded-xl px-3 py-2.5"
                ...
                background: room.phase === "playing" && isMyTurn
                  ...
                  : room.phase === "voting"
                    ...
                    : room.phase === "quiz"
                      ? "rgba(232,185,35,0.1)"
                      : "rgba(255,255,255,0.03)",
                border: `1px solid ${room.phase === "playing" && isMyTurn ? "rgba(0,200,83,0.3)"
